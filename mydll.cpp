...
int ArcherAttack(Info &info, mySoldier attacker, enemyTarget target);
...
int attack(Info &info) {
	...
	for (int i = 0; i < mysodnum; i++) {
		...
		if (mysod[i].type == HeavyArcher || mysod[i].type == LightArcher)
...
int ArcherAttack(Info &info, mySoldier attacker, enemyTarget target) {
	...
	if (inplace) {
		...
		if (target.type) {
			...
			movetargetlist[0].x = target.pos.x;
			movetargetlist[0].y = target.pos.y + 3;
			movetargetlist[1].x = target.pos.x + 1;
			movetargetlist[1].y = target.pos.y + 2;
			movetargetlist[2].x = target.pos.x + 2;
			movetargetlist[2].y = target.pos.y + 2;
			movetargetlist[3].x = target.pos.x + 2;
			movetargetlist[3].y = target.pos.y + 1;
			movetargetlist[4].x = target.pos.x + 3;
			movetargetlist[4].y = target.pos.y;
			movetargetlist[5].x = target.pos.x + 2;
			movetargetlist[5].y = target.pos.y - 1;
			movetargetlist[6].x = target.pos.x + 2;
			movetargetlist[6].y = target.pos.y - 2;
			movetargetlist[7].x = target.pos.x + 1;
			movetargetlist[7].y = target.pos.y - 2;
			movetargetlist[8].x = target.pos.x;
			movetargetlist[8].y = target.pos.y - 3;
			movetargetlist[9].x = target.pos.x - 1;
			movetargetlist[9].y = target.pos.y - 2;
			movetargetlist[10].x = target.pos.x - 2;
			movetargetlist[10].y = target.pos.y - 2;
			movetargetlist[11].x = target.pos.x - 2;
			movetargetlist[11].y = target.pos.y - 1;
			movetargetlist[12].x = target.pos.x - 3;
			movetargetlist[12].y = target.pos.y;
			movetargetlist[13].x = target.pos.x - 2;
			movetargetlist[13].y = target.pos.y + 1;
			movetargetlist[14].x = target.pos.x - 2;
			movetargetlist[14].y = target.pos.y + 2;
			movetargetlist[15].x = target.pos.x - 1;
			movetargetlist[15].y = target.pos.y + 2;
			for (int i = 0; i < 16; i++) {
				int temp_dis = GetDistance1(attacker.lastpos, movetargetlist[i]);
				if (!(info.pointInfo[movetargetlist[i].x][movetargetlist[i].y].occupied) && temp_dis < distance1) {
					movetarget = movetargetlist[i];
			...
			movetargetlist[0].x = target.pos.x - 4;
			movetargetlist[0].y = target.pos.y;
			movetargetlist[1].x = target.pos.x - 4;
			movetargetlist[1].y = target.pos.y + 1;
			movetargetlist[2].x = target.pos.x - 3;
			movetargetlist[2].y = target.pos.y + 2;
			movetargetlist[3].x = target.pos.x - 3;
			movetargetlist[3].y = target.pos.y + 3;
			movetargetlist[4].x = target.pos.x - 2;
			movetargetlist[4].y = target.pos.y + 3;
			movetargetlist[5].x = target.pos.x - 1;
			movetargetlist[5].y = target.pos.y + 4;
			movetargetlist[6].x = target.pos.x;
			movetargetlist[6].y = target.pos.y + 4;
			movetargetlist[7].x = target.pos.x + 1;
			movetargetlist[7].y = target.pos.y + 4;
			movetargetlist[8].x = target.pos.x + 2;
			movetargetlist[8].y = target.pos.y + 3;
			movetargetlist[9].x = target.pos.x + 3;
			movetargetlist[9].y = target.pos.y + 3;
			movetargetlist[10].x = target.pos.x + 3;
			movetargetlist[10].y = target.pos.y + 2;
			movetargetlist[11].x = target.pos.x + 4;
			movetargetlist[11].y = target.pos.y + 1;
			movetargetlist[12].x = target.pos.x + 4;
			movetargetlist[12].y = target.pos.y;
			movetargetlist[13].x = target.pos.x + 4;
			movetargetlist[13].y = target.pos.y - 1;
			movetargetlist[14].x = target.pos.x + 3;
			movetargetlist[14].y = target.pos.y - 2;
			movetargetlist[15].x = target.pos.x + 3;
			movetargetlist[15].y = target.pos.y - 3;
			movetargetlist[16].x = target.pos.x + 2;
			movetargetlist[16].y = target.pos.y - 3;
			movetargetlist[17].x = target.pos.x + 1;
			movetargetlist[17].y = target.pos.y - 4;
			movetargetlist[18].x = target.pos.x;
			movetargetlist[18].y = target.pos.y - 4;
			movetargetlist[19].x = target.pos.x - 1;
			movetargetlist[19].y = target.pos.y - 4;
			movetargetlist[20].x = target.pos.x - 2;
			movetargetlist[20].y = target.pos.y - 3;
			movetargetlist[21].x = target.pos.x - 3;
			movetargetlist[21].y = target.pos.y - 3;
			movetargetlist[22].x = target.pos.x - 3;
			movetargetlist[22].y = target.pos.y - 2;
			movetargetlist[23].x = target.pos.x - 4;
			movetargetlist[23].y = target.pos.y - 1;
			for (int i = 0; i < 24; i++) {
				int temp_dis = GetDistance1(attacker.lastpos, movetargetlist[i]);
				if (!(info.pointInfo[movetargetlist[i].x][movetargetlist[i].y].occupied) && temp_dis < distance1) {
					movetarget = movetargetlist[i];
	...
	//撤退
	{
		...
		int *score = new int[tar1.size()];
		for (int i = 0; i < tar1.size(); i++) {
			score[i] = GetDistance1(tar1[i], target.pos) * 2;
			if (tar1[i].land == River)score[i] -= (attacker.move - 1) * 2;
			if (tar1[i].land == Forest) {
				if (attacker.type == LightArcher)score[i]++;
				if (attacker.type == HeavyArcher)score[i]++;
			}
			if (tar1[i].land == Dorm) {
				if (attacker.type == HeavyArcher)score[i]++;
			}
